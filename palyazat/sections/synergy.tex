...
\begin{itemize}
  ...
  ELTE BTK (Central-Eastern Europe) contributes specialized AI-based processing and digital humanities expertise through its National Laboratory for Digital Heritage. Sorbonne Université (Atlantic region) coordinates the documentation of medieval fortifications and coastal erosion. Together with the Babeș-Bolyai University (UBB) as the coordinator (CO), this partnership ensures a robust, cross-disciplinary framework that addresses the most pressing heritage challenges across diverse European regions.
\end{itemize}
