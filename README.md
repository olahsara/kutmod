# Kutatásmódszertan 3. csoport dokumentumai
...
_(Mentőöv vagy csapda? A "vibe coding" és a túlzott AI-hagyatkozás következményei)_
...
- **Feladatok:** A "vibe coding" és a paradigmaváltás bemutatása, a kutatási probléma megalapozása, valamint a _Cognitive Offloading_ (kognitív tehermentesítés) és az _Illusion of Competence_ (illuzórikus kompetencia) elméleti hátterének kidolgozása.
...
_Közös feladatok:_ Az Absztrakt megírása, a LaTeX formázás, a `refs.bib` fájl karbantartása és a végső lektorálás.
...
### 🤝 Fő partnerek és szerepük

#### Technológiai partner – Arts et Métiers (CAPLAB / Laval Virtual)

> XR, digitális ikrek és 4D adatgyűjtés (mozgás, gesztusok, fiziológiai adatok).

A projekt révén:

- új alkalmazási terület: kulturális örökség
- technológia validáció valós környezetben
- kutatási output és publikációk növelése
- EU-s hálózatépítés erősítése

#### Kiadó – Springer Nature

> Open access és open science fókusz.

A projekt révén:

- nagy mennyiségű interdiszciplináris publikáció
- növekvő láthatóság és idézettség
- új kutatási terület: digital heritage + XR
- 3D modellek és adatkészletek integrálása az open science ökoszisztémába

### 🌍 Regionális kutatási partnerek
...
- digitális dokumentáció bevezetése
...
- Kulturális örökség digitális megőrzése és hozzáférhetővé tétele
- összehasonlítható, szabványosított 3D adatbázisok létrehozása
- új kutatási irányok az XR és örökségvédelem metszetében
- tömegturizmus csökkentése virtuális élményeken keresztül
- európai szintű kutatási és innovációs együttműködések erősítése

### 📌 Konklúzió

A projekt egy interdiszciplináris, európai szintű együttműködés, amely a legmodernebb digitális technológiákat alkalmazza a kulturális örökség megőrzésére. Egyszerre szolgál tudományos, technológiai és társadalmi célokat, miközben erősíti az open science és a digitális örökségvédelem szerepét Európában.
